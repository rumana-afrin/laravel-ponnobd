...
<div class="container-fluid">
    <div class="card mt-4" id="basic-info">
        ...
        <div class="card-body pt-0">
            <form action="{{ route('categories.menus.update',$menu->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                                type="text" placeholder="Name" autocomplete="off" value="{{ $menu->name }}">
                        </div>
                        @error('name')
                    ...
                    <div class="col-6 @error('parent_id') border-danger @enderror">
                        <div class="input-area">
                            ...
                            <x-select name="parent_id">
                                ...
                                <option value="{{ $men->id }}" @selected($men->id == $menu->parent_id)>{{ $men->name }}</option>
                                @endforeach
                            </x-select>
                        </div>
                        @error('parent_id')
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="url" name="url" class="form-control @error('url') is-invalid @enderror"
                                type="url" placeholder="URL" autocomplete="off" value="{{ $menu->url }}">
                        </div>
                        @error('url')
                        <div class="text text-danger">
                            {{ $message }}
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <select name="target" id="target" class="form-select @error('target') is-invalid @enderror">
                                <option value="_self" @selected($menu->target == '_self')>Self</option>
                                <option value="_blank" @selected($menu->target == '_blank')>Blank</option>
                            </select>
                        </div>
                        @error('target')
                        <div class="text text-danger">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="icon" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                type="text" placeholder="Icon class name" autocomplete="off" value="{{ $menu->icon }}">
                        </div>
                        @error('icon')
                        <div class="text text-danger">
                            {{ $message }}
