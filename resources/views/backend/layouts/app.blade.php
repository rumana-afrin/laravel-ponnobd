...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ uploadedFile(settings('site_icon')) }}">
    <title>
    ...
    <!-- jQuery -->
    <script src="{{ asset('assets/js') }}/jquery-3.7.0.min.js" integrity="sha256-2Pmvv0kuTBOenSvLm6bvfBSSHrUJ+3A7x6P5Ebd07/g=" crossorigin="anonymous"></script>
    <link href="{{ asset('/') }}/backend/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('/') }}/backend/assets/css/argon-dashboard.css?v=2.0.6" rel="stylesheet" />
