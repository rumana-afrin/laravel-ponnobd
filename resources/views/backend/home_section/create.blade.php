...
<div class="container-fluid">
    <div class="card mt-4" id="basic-info">
        ...
        <div class="card-body pt-0">
            <form action="{{ route('settings.home.section.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="order" name="order" class="form-control @error('order') is-invalid @enderror"
                                type="number" placeholder="Ex: 2" autocomplete="off" value="{{ old('order') }}">
                        </div>
                        @error('order')
                        <div class="text text-danger">
                            {{ $message }}
                    ...
                    <div class="col-12 ">
                        <div class="input-area @error('short_description') border-danger @enderror">
                            ...
                            <textarea name="short_description" class="form-control" cols="30" rows="3" placeholder="Write short description"></textarea>
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="button_text" name="button_text" class="form-control @error('button_text') is-invalid @enderror"
                                type="text" placeholder="Ex: View All" autocomplete="off" value="{{ old('button_text') }}">
                        </div>
                        @error('button_text')
                        <div class="text text-danger">
                            {{ $message }}
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input id="button_url" name="button_url" class="form-control @error('button_url') is-invalid @enderror"
                                type="url" placeholder="URL" autocomplete="off" value="{{ old('button_url') }}">
                        </div>
                        @error('button_url')
                        <div class="text text-danger">
                            {{ $message }}
                    ...
                    <div class="col-12 @error('category_ids') border-danger @enderror">
                        <div class="input-area">
                            ...
                            <x-select name="category_ids[]" id="category_ids" multiple>
                                ...
                                <option value="{{ $category->id }}" @selected(is_array(old('category_ids')) && in_array($category->id,old('category_ids')))>{{ $category->name }}</option>
                                @endforeach
                            </x-select>
                        </div>
                    </div>
