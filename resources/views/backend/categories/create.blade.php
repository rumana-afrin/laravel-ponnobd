...
<div class="container-fluid">
    <div class="card mt-4" id="basic-info">
        ...
        <div class="card-body pt-0">
            <form action="{{ route('categories.store') }}" novalidate method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6 @error('parent_category_id') border-danger @enderror">
                        <div class="input-area">
                            ...
                            <select class="form-select" name="parent_category_id" id="parentCategory"
                                ...
                                <option value="{{ $category->id }}" @selected($category->id == old('parent_category_id'))>{{ $category->name }}
                    ...
                    <div class="col-12 pt-2 ">
                        ...
                        <x-upload-file name="icon" fileType='image' value="{{ old('icon') }}"/>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <x-textarea name='meta_description' placeholder='Write meta description' value="{{ old('meta_description') }}" required/>
